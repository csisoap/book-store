...
public class ProductServlet extends HttpServlet {
    ...
    private final ProductReviewService productReviewService = (ProductReviewService) ServiceFactory.getService(Enums.ServiceType.PRODUCT_REVIEW);
    private final WishlistItemService wishlistItemService = (WishlistItemService) ServiceFactory.getService(Enums.ServiceType.WISHLIST_ITEM);
